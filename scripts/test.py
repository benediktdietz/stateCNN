...
prediction_target = ["angles", "obj_pos", "tip_pos", "target_pos"]  # use None or "ALL" for the full 22-dimensional target
...
subset_ratio_per_dataset = 1  # if None or 1 then the full dataset is being used
